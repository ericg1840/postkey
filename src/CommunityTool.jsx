...
const TEMPLATES = {
  spotlight: {
    ...
    subjectPlaceholder: "The Corner Bakehouse",
    bodyLabel: "WHY YOU LOVE IT",
    bodyPlaceholder: "Their sourdough sells out by 10am, and it's worth setting an alarm for.",
  },
  reno_tip: {
    label: "Reno Tip",
    word1: "Reno",
...
const DEFAULTS = {
  ...
  subject: "The Corner Bakehouse",
  body: "Their sourdough sells out by 10am, and it's worth setting an alarm for.",
