...
CREATE TABLE IF NOT EXISTS content_recurring_topics (
...
CREATE INDEX IF NOT EXISTS content_recurring_topics_user_id_idx ON content_recurring_topics(user_id);
...
ALTER TABLE content_posts ADD COLUMN IF NOT EXISTS recurring_topic_id INTEGER REFERENCES content_recurring_topics(id) ON DELETE SET NULL;
